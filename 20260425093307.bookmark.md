...
<div id="BannerPromo">
<a href="http://store.daringfireball.net/" style="border: 0; padding: 0;" class="no_underlines">
<img src="/members/images/thumbs/" alt="DF t-shirt promotion." height="128">
</a>
</div>
...
<a href="https://recleague.com/?lyr_campaign=df">
	<img alt="Rec League" src="/martini/images/rec_league.png" height="90">
</a>
<p><a href="https://recleague.com/?lyr_campaign=df">Rec League</a>:<br> Share what you’re into<br> and find your people.</p>
</div>
...
<h2>Installation and Requirements <a id="install"></a></h2><a id="install">

</a><p><a id="install">Markdown requires Perl 5.6.0 or later. Welcome to the 21st Century.
Markdown also requires the standard Perl library module </a><a href="http://search.cpan.org/dist/Digest-MD5/MD5.pm">Digest::MD5</a>, which is probably already installed on your server.</p>
...
<h2>Acknowledgements <a id="acknowledgements"></a></h2><a id="acknowledgements">

</a><p><a id="acknowledgements"></a><a href="http://www.aaronsw.com/">Aaron Swartz</a> deserves a tremendous amount of credit for his feedback on the
