...
[archinstall](https://wiki.archlinux.org/title/Archinstall){rel="noopener noreferrer"} library, but I
...
run [X](https://github.com/tomaskala/suckless){rel="noopener noreferrer"} or
[Wayland](https://github.com/tomaskala/suckmore){rel="noopener noreferrer"}

First, download an image from [https://archlinux.org/download/](https://archlinux.org/download/){rel="noopener noreferrer"} and copy it to a
